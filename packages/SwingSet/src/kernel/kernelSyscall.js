...
export function makeKernelSyscallHandler(tools) {
   ...
   *   often organized hierarchically. This iteration API allows simple
   *   iteration over an explicit key range or iteration over the set of keys
   *   with a given prefix, depending on how you use it:
   *
