 ...
 *
 * See https://github.com/Agoric/agoric-sdk/pull/3567 TODO Once that PR is
 * merged, link to the documents rather than the PRs.
 *
 ...
 * @template K,V
 * @param {string} [keyName='key'] - The column name for the key. Default is `'key'`
